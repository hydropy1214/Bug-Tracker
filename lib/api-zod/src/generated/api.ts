...
export const ListFindingsResponseItem = zod.object({
  ...
  "evidenceQuality": zod.enum(['weak', 'standard', 'strong']).optional(),
  "verificationMethod": zod.string().optional(),
  "reproducibility": zod.enum(['reproducible', 'intermittent', 'not_reproducible', 'not_tested']).optional(),
  "affectedEndpoint": zod.string().optional(),
  "affectedParameter": zod.string().optional(),
  "negativeTests": zod.string().optional(),
  "limitations": zod.string().optional(),
  "toolInfo": zod.string().optional(),
...
export const createFindingBodyEvidenceQualityDefault = `standard`;
export const createFindingBodyReproducibilityDefault = `not_tested`;
...
export const CreateFindingBody = zod.object({
  ...
  "evidenceQuality": zod.enum(['weak', 'standard', 'strong']).default(createFindingBodyEvidenceQualityDefault),
  "verificationMethod": zod.string().optional(),
  "reproducibility": zod.enum(['reproducible', 'intermittent', 'not_reproducible', 'not_tested']).default(createFindingBodyReproducibilityDefault),
  "affectedEndpoint": zod.string().optional(),
  "affectedParameter": zod.string().optional(),
  "negativeTests": zod.string().optional(),
  "limitations": zod.string().optional(),
